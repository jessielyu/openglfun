...
//	pinhole_ptr->set_lookat(1, 4, 0);    
//	pinhole_ptr->set_view_distance(2400.0);  
//	pinhole_ptr->set_view_distance(2.0/3.0);
//	pinhole_ptr->compute_uvw();     
//	set_camera(pinhole_ptr);
//	
//	
...
//	dielectric_ptr->set_cf_out(white);
//	
//	char* file_name = "../../PLYFiles/Bunny4K.ply"; 				// for Figure 28.13(a)
...
//	plane_ptr->transform_texture(true);
//	add_object(plane_ptr);	
//	
//}
...
//	
//	Plane* plane_ptr = new Plane(Point3D(0, -6.5, 0), Normal(0, 1, 0));  
//	plane_ptr->set_material(sv_matte_ptr);//white_matte_ptr);
//	add_object(plane_ptr);
//}
